...
/* ----------------------------------------------------------------------------- Enumeration of
   types of the operands in the opcode map. The naming was inspired by the AMD manuals. To
   understand the specifics, read the manuals.
   ----------------------------------------------------------------------------- */
typedef enum
{
  OP_NONE = 0,
