...
#define kmem_cache_create(args...) ({(void)radix_tree_node_ctor; NULL;})
#define hotcpu_notifier(fn, pri) ((void)(fn))
...
{
    return malloc(sizeof(struct radix_tree_node));
}
